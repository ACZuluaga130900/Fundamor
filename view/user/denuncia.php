            ...
            <div class="container">
                ...
                <div class="row contenedor-formulario">
                    <div class="col-md-12">
                        ...
                        <form class="needs-validation contenido-formulario" novalidate>
                            <div class="form-row">
                                    ...
                                    <section class="tipo-denuncia" id="tipo-denuncia">
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                ...
                                                <input v-model="newUser.first_name" type="text" class="form-control"
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                ...
                                                <input v-model="newUser.last_name" type="text" class="form-control"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-8">
                                                <input v-model="newUser.document_number" type="text"
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                ...
                                                <input v-model="newUser.telephone_number" type="text"
                            ...
                            <div class="form-row">
                                <div class="col-md-1 huellas"></div>
                                <div class="col-md-9">
                                    <label class="subtitulo" for="informacion-adicional">Información adicional acerca de
                                        los hechos</label>
                                    <section class="informacion-adicional" id="informacion-adicional">
                                        <!-- Fila del campo de texto nombre del resposnable -->
                                        <div class="form-row">
                                            <div class="col-12">
                                                <label for="nombre_responsable">Nombre del responsable</label>
                                                <input v-model="newUser.first_name" type="text" class="form-control"
                                                    id="validationCustom01" placeholder="Nombre del responsable"
                                                    required>
                                            </div>
                                        </div>

                                        <!-- Fila del campo de texto nombre del animal -->
                                        <div class="form-row">
                                            <div class="col-12">
                                                <label for="nombre_animal">Nombre del animal</label>
                                                <input v-model="newUser.last_name" type="text" class="form-control"
                                                    id="nombre_animal" placeholder="Nombre del animal" required>
                                            </div>
                                        </div>
